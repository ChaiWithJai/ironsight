 ...
 *
 * MUST PROVE: cascade transitions, PCSS contact hardening, GTAO in creases, SSR on wet stone.
 *
 * Empty on purpose until LIGHT lands. Registering a shot that renders nothing
