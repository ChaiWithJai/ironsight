/**
 * PHYS's shot file. Owned by PHYS and by nobody else.
 *
 * MUST PROVE: a cover wall mid-collapse and after settle, with the sightline it opened.
 *
 * Empty on purpose until PHYS lands. Registering a shot that renders nothing
