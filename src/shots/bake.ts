 ...
 *
 * MUST PROVE: material chart: close-up, grazing angle and at distance — no tiling, no smoothness on approach.
 *
 * Empty on purpose until BAKE lands. Registering a shot that renders nothing
