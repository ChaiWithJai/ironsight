 ...
 *
 * MUST PROVE: the mixer / occlusion debug overlay rendered in-canvas (audio still needs a visual proof).
 *
 * Empty on purpose until AUDIO lands. Registering a shot that renders nothing
