/**
 * AI's shot file. Owned by AI and by nobody else.
 *
 * MUST PROVE: a bot squad advancing and using cover, path debug, soldier silhouette at 3 LODs.
 *
 * Empty on purpose until AI lands. Registering a shot that renders nothing
