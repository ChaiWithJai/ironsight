/**
 * WATER's shot file. Owned by WATER and by nobody else.
 *
 * MUST PROVE: sun glitter off the water, shoreline foam, refraction, the half-sunk freighter waterline.
 *
 * Empty on purpose until WATER lands. Registering a shot that renders nothing
