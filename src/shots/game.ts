 ...
 *
 * MUST PROVE: a contested capture in progress: capture bar, tickets bleeding, killfeed live.
 *
 * Empty on purpose until GAME lands. Registering a shot that renders nothing
