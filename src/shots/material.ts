 ...
 *
 * MUST PROVE: the uber material across every SurfaceId, wear and micro-detail readable at 0.3 m.
 *
 * Empty on purpose until RCORE lands. Registering a shot that renders nothing
